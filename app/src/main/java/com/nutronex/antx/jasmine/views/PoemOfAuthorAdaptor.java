...
import com.nutronex.antx.jasmine.PoemOfAuthorActivity;
...
public class PoemOfAuthorAdaptor extends RecyclerView.Adapter<PoemOfAuthorAdaptor.Vholder> {


    Context c ;
    PoemOfAuthorActivity activity;
    Typeface zawgyifont ;
    ArrayList<Post> data ;


    public PoemOfAuthorAdaptor(Context c, ArrayList<Post> poemlist) {
        this.data = poemlist;
        this.activity = (PoemOfAuthorActivity) c;
        this.c =c ;
